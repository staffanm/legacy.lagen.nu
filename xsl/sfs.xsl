...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="docmetadata">
	...
	<dd property="rinfoex:tidsbegransad"><xsl:value-of select="//xht2:dd[@property='rinfoex:tidsbegransad']"/></dd>
      ...
      <dt>Källa</dt>
      <dd rel="dct:publisher" resource="http://lagen.nu/org/2008/regeringskansliet"><a href="http://rkrattsbaser.gov.se/sfst?bet={//xht2:dd[@property='rinfo:fsNummer']}">Regeringskansliets rättsdatabaser</a></dd>
      <dt>Senast hämtad</dt>
